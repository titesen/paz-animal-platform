...
* *Ejemplo:* El controlador, el servicio, las rutas y los tests de "Mascotas" viven en modules/pets/.
...
* *Excepción:* Textos visibles para el usuario en el Frontend (UI Strings).
...
* **Constantes:** UPPER\_SNAKE\_CASE (ej. MAX\_FILE\_SIZE, DEFAULT\_PAGE\_LIMIT).  
...
src/  
├── components/  
│   └── ui/                  \# Componentes Base (Shadcn \- Atomic Design) \[cite: 376\]  
│       ├── Button.tsx  
│       └── Dialog.tsx  
