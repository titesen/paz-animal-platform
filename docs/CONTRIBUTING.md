...
1. **Busca primero:** Revisa si el error ya fue reportado en los _Issues_ abiertos.
...
1. Abre un _Issue_ con la etiqueta enhancement.
2. **Justificación:** Explica _por qué_ es necesario y a quién beneficia (Usuarios, Admins, Mascotas).
