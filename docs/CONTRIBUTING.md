...
Si encuentras un error, por favor crea un _Issue_ en GitHub siguiendo estos pasos:
...
¿Tienes una idea para mejorar la adopción o las donaciones? Abre un _Issue_ con la etiqueta `enhancement`.

- **Justificación:** Explica por qué es necesario y a quién beneficia (Usuarios, Admins, Mascotas).
- **Propuesta Técnica:** Si es posible, sugiere qué tecnologías o endpoints se necesitarían.
...
4. **Commits:** Usa _Conventional Commits_ (ver abajo).
5. **Push & PR:** Sube tu rama y abre un Pull Request hacia `main`.

> **Nota:** El CI (GitHub Actions) ejecutará los tests automáticamente.
...
- Usa HTML semántico.
- No elimines el _outline_ de foco.
...
Nos comprometemos a ofrecer un entorno libre de acoso para todos. Por favor, lee y respeta nuestro `CODE_OF_CONDUCT.md`. La amabilidad y la empatía son tan importantes como el código limpio.

---

## 5. Recursos Adicionales

- **Diccionario de Datos:** Consulta `diccionario_de_datos.pdf` para entender la DB V23.
