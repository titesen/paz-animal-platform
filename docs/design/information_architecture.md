...
- **Breadcrumbs (Migas de pan):** Vital para navegación profunda.
  - _Ejemplo:_ Inicio \> Adoptar \> Perros \> Firulais.
...
- _Ejemplo:_ Una noticia sobre "Campaña de Invierno" y un perro que necesita "Abrigo" pueden compartir el tag \#Invierno.
