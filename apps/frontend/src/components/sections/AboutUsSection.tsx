...
const AboutUsSection: React.FC = () => {
  return (
    <section className="py-24 bg-secondary-100 dark:bg-slate-800 transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 dark:text-white">
            Nuestra <span className="text-primary-600">Misión</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 text-center">
          ...
          <div className="flex flex-col items-center relative">
            ...
            <div className="hidden md:block absolute top-8 -left-1/2 w-full h-[2px] bg-primary-600/10 -z-10"></div>

            <div className="w-16 h-16 bg-primary-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-primary-600/30 mb-6 -rotate-3 hover:rotate-0 transition-transform">
              <Target size={32} />
            </div>
            <h3 className="text-2xl font-display font-bold text-slate-900 dark:text-white mb-4">
              Misión
          ...
          {/* Valores */}
          <div className="flex flex-col items-center relative">
            <div className="hidden md:block absolute top-8 -right-1/2 w-full h-[2px] bg-primary-600/10 -z-10"></div>

            <div className="w-16 h-16 bg-white dark:bg-slate-700 rounded-2xl flex items-center justify-center text-primary-600 shadow-sm mb-6 rotate-3 hover:rotate-0 transition-transform">
              <Heart size={32} fill="currentColor" className="text-primary-600/20" />
            </div>
            <h3 className="text-2xl font-display font-bold text-slate-900 dark:text-white mb-4">
              Valores
            </h3>
