        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-70">
          ...
          {['Royal Canin', 'Mercado Pago', 'Municipalidad', 'PetShop'].map((name, i) => (
            <div key={i} className="group cursor-pointer transition-all duration-300">
              <span className="text-xl md:text-2xl font-display font-bold text-slate-400 grayscale group-hover:grayscale-0 group-hover:text-primary-600 transition-all duration-500">
                {name}
              </span>
            </div>
          ))}
